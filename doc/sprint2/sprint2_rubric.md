...
## Tracking on Trello  (max 24 marks) 
  ...
  - Burndown chart (max 2 marks)
    ...
    Ideal remaining should be a straight line.
  ...
  - Schedule (max 2 marks)
    ...
    Docs + Design should not really be part of the chart, only the stories/tasks that count towards your actual product.
...
## Workload distribution in time (Max 20 marks) 
  ...
  Commits in week one = 4
  Commits in week two = >100
